...
| `topic`        | yes      | The endpoint channel the message flows over (Dapr topic, kebab-case); the consuming loader subscribes to the same. Registry resolution records the resolved channel in the record's publishes block; set this to match. |
